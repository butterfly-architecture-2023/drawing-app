...
class iOSMainViewController: UIViewController {
  ...
  private lazy var squareButton: UIButton = UIButton(frame: .init(origin: .zero, size: CGSize(width: 80, height: 30)))
  private lazy var vectorButton: UIButton = UIButton(frame: .init(origin: .zero, size: CGSize(width: 80, height: 30)))
  private lazy var buttonsLayer: UIStackView = UIStackView(frame: .init(origin: .zero, size: CGSize(width: 300, height: 50)))
